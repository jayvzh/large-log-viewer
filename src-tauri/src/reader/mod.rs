...
impl LogFileReader {
    ...
    pub fn decode_line(data: &[u8], encoding: FileEncoding) -> String {
        match encoding {
            FileEncoding::Utf8 | FileEncoding::Auto => String::from_utf8_lossy(data).into_owned(),
            FileEncoding::Utf16LE => encoding_rs::UTF_16LE.decode(data).0.into_owned(),
            FileEncoding::Utf16BE => encoding_rs::UTF_16BE.decode(data).0.into_owned(),
            FileEncoding::Ansi => encoding_rs::WINDOWS_1252.decode(data).0.into_owned(),
        }
    }
